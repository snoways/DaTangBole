...
class HostingOrderController extends AdminbaseController
{
    ...
    public function index()
    {
        ...
        $count=$oauth_user_model
            ...
            ->join('LEFT JOIN fzm_small_table ON fzm_small_table.id=fzm_hosting_order.st_id')
            ->where($where)
            ->count();
        ...
        $lists = $oauth_user_model
            ...
            ->field('*, fzm_parents.phone as f_phone, fzm_hosting_order.status as o_status, fzm_hosting_order.id as oid, fzm_small_table.s_name')
            ->select();
