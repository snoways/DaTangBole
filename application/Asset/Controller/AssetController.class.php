...
class AssetController extends AdminbaseController {
    ...
    public function plupload(){
        ...
        if (IS_POST) {
            ...
            $upload_max_filesize=empty($upload_max_filesize)?209715200:$upload_max_filesize;//默认2M
            ...
            if ($info) {
                ...
                $filepath = '/data/upload/'.$savepath.$first['savename'];
//                $filepath = 'data/upload/'.$savepath.$first['savename'];
                $data = array('preview_url'=>$preview_url,'filepath'=>$filepath,'url'=>$url,'name'=>$oriName,'status'=>1,'message'=>'success');
