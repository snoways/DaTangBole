                    ...
                    submitHandler: function (form) {
                        ...
                        $form.ajaxSubmit({
                            ...
                            success: function (data, statusText, xhr, $form) {
                                ...
                                // console.log(data);
                                if (data.status === 1) {
                                    layer.msg(data.info, {icon: 1, time: 1200, shade: [0.6, '#000000']},
                                        function () {
                                            if (data.url) {
                                    ...
                                    layer.msg(data.info, {icon: 2, time: 1500, shade: [0.6, '#000000']});
                                }
                                // console.log(data)

                                // if (data.status === 1) {
                                //     $('<span style="font-size: 16px; margin-left: 10px;">' + data.info + '</span>').
                                //     appendTo($btn.parent()).fadeIn('slow').delay(500).fadeOut(function () {
                                //         if(data.url){
                                //             window.location.href = data.url;
                                //         }
                                //     });
                            ...
                            error: function (xhr, e, statusText) {
                                layer.msg(statusText, {icon: 2, time: 2000, shade: [0.6, '#000000']},
                                    function () {
                                        //刷新当前页
                                        reloadPage(window);
                                    }
